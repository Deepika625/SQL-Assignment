...
(
  ...
  insert into Customers values(1,'deepu','anu','vizag','india',1233455667)
  insert into Customers values(2,'vital','surendra','usm','Germany',1233445566)
  insert into Customers values(3,'nani','kammal','sanu','Goa',122343455)
